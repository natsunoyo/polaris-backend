...
import com.jobportal.polaris_backend.service.UserService;
...
public class UserAPI {
    ...
    public ResponseEntity<ResponseDTO>verifyOtp(@PathVariable String email, @PathVariable @Pattern(regexp="^[0-9]{6}$", message = "{otp.invalid}") String otp) throws JobPortalException {
